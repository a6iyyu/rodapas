...
@section("konten")
    ...
    <main class="container mx-auto my-14 w-9/10">
        ...
        <a href="{{ route("log-suara") }}" class="fixed bottom-6 left-1/2 -translate-x-1/2 flex gap-4 z-50 items-center pl-3 pr-6 py-2 rounded-full bg-[#ef4444] text-white text-sm shadow-lg transition-all duration-300 ease-in-out lg:hover:bg-[#dc2626]">
